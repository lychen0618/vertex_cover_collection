...
using vcc::RandomEnum;

namespace {
class RandomEnumTest : public ::testing::Test {
protected:
    RandomEnumTest() {}
    ~RandomEnumTest() override {}
};

TEST_F(RandomEnumTest, SimpleExampleTest) {
    ...
    for (MMCS::Method m : {MMCS::Method::ORDER, MMCS::Method::RANDOM,
        ...
        RandomEnum random_enum(hyper_graph, output_queue, 4);
        random_enum.SetMethod(m);
